...
// the GitHub Releases API for malcolmston/lucene.
const RELEASE_LIBS: RelLib[] = [
  { name: LUCENE.name, icon: LUCENE.icon, accent: LUCENE.accent, repo: ghrepo(LUCENE), url: LUCENE.repo },
];
